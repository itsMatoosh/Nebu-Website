        ...
        <div class="col sidebar pl-3 pr-3">
            ...
            <div id="nav" class="row h-25 text-center">
                <nav class="col stroke">
                    <div class="row">
                        <div class="col"><p class="h3 underline" onclick="transition('restaurant',null, false);">
                                restaurant</p></div>
                    </div>
                    <div class="row">
                        <div class="col"><p class="h3 underline" onclick="transition('grill',null, false);">grill</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><p class="h3 underline" onclick="transition('bar',null, false);">bar</p></div>
                    </div>
                    <div class="row">
                        <div class="col"><p class="h3 underline" onclick="transition('shisha',null, false);">shisha</p>
                        </div>
                    </div>
                </nav>
            </div>
            ...
            <div class="row" style="height: 30vh;">
                <div class="col">
                    <div class="page-title" style="white-space: nowrap; text-decoration: none;">
                        <h3 id="page-title" class="navbar-element" onclick="transitionSubpage('main')">title</h3>
